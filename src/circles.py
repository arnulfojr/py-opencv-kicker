...
def detect_box(output):
    ...
    if len(pp) > 3:
        ...
        cv2.putText(output, "No contour detected", (100, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (50, 170, 50), 2)
...
while True:
    ...
    circles = cv2.HoughCircles(blur, cv2.HOUGH_GRADIENT, 1, 200,
                               param1=50, param2=20, minRadius=BALL_MIN_RADIUS, maxRadius=BALL_MAX_RADIUS)
